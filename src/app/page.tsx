    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-black p-6 overflow-hidden relative">
      ...
      <div className="z-10 w-full max-w-4xl space-y-12 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
          ...
          <Link href="/video" className="group block cursor-pointer">
            <motion.div
              initial={{ opacity: 0, x: -30 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.8, delay: 0.1 }}
              whileHover={{ y: -8 }}
              className="relative rounded-2xl border border-white/10 bg-white/5 p-8 text-left backdrop-blur-xl shadow-2xl transition-all duration-300 hover:border-purple-500/50 hover:bg-white/10"
            >
              ...
              <span
                className="inline-flex items-center gap-2 rounded-full bg-purple-600 px-5 py-2.5 text-sm font-bold text-white shadow-lg shadow-purple-500/20 transition-all group-hover:bg-purple-500 group-hover:scale-105 duration-200"
              >
          ...
          <Link href="/comics" className="group block cursor-pointer">
            <motion.div
              initial={{ opacity: 0, x: 30 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.8, delay: 0.1 }}
              whileHover={{ y: -8 }}
              className="relative rounded-2xl border border-white/10 bg-white/5 p-8 text-left backdrop-blur-xl shadow-2xl transition-all duration-300 hover:border-indigo-500/50 hover:bg-white/10"
            >
              ...
              <span
                className="inline-flex items-center gap-2 rounded-full bg-indigo-600 px-5 py-2.5 text-sm font-bold text-white shadow-lg shadow-indigo-500/20 transition-all group-hover:bg-indigo-500 group-hover:scale-105 duration-200"
              >
